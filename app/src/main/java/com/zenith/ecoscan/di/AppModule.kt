...
import com.zenith.ecoscan.repository.Repository
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideIDataRepository(apiService: ApiService, dataDao: DataDao) : IDataRepository {
        return Repository(apiService, dataDao)
    }
